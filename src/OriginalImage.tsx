...
import registDragEvent from "./dragresize/utils/registDragEvent.ts";
import {inrange} from "./dragresize/utils";
import Boundary from "./dragresize/Boundary.tsx";
...
const OriginalImage = () => {
  ...
  const originalImageId = params.originalImageId as unknown as number

  const [image, setImage] = useState('');

  const getImage = async () => {
    const apiPath = `/originalImages/${originalImageId}/bytes`;
    api.get(apiPath, {
